...
type RoomEvent = | { type: "clock"; data: number } // Existing event type
| { type: "vote"; data: { question:string ,time:number, choices: string[] } } // New event type for voting
| { type: "choseChoice"; data: { userId?: string; choice: string } }; // New event type for user choice
